...
- Xcode 26 / Swift 6.2 (`swift-tools-version:6.2`), iOS 15, macOS 12. Apple requires the iOS 26 SDK for App Store Connect uploads, so there's no reason to support older Xcodes.
