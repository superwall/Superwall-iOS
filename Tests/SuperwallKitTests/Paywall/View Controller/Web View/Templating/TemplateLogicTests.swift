...
final class TemplateLogicTests: XCTestCase {
  ...
  func test_getBase64EncodedTemplates_oneProduct_noFreeTrial_userAttributes() async {
    ...
    let productVariables = [ProductVariable(name: "primary", attributes: ["period": "month"], id: "primary_product_id", hasFreeTrial: false)]
    let userAttributes = [
      "name": "Yusuf"
    ]
    let deviceDict = [
  ...
  func test_getBase64EncodedTemplates_threeProducts_freeTrial_userAttributes() async {
    ...
    let productVariables = [
      ProductVariable(name: "primary", attributes: ["period": "month"], id: "primary_product_id", hasFreeTrial: false),
      ProductVariable(name: "secondary", attributes: ["period": "month"], id: "secondary_product_id", hasFreeTrial: false),
      ProductVariable(name: "tertiary", attributes: ["period": "month"], id: "tertiary_product_id", hasFreeTrial: false),
    ]
    let userAttributes = [
      "name": "Yusuf"
    ]
