...
- Fixes `register` calls stalling at cold launch for subscribers on a weak network. When the saved entitlements show the user is still subscribed, the SDK is now ready before it reads purchases from StoreKit.
