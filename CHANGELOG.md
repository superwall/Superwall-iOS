...
- Fixes `register` calls stalling at cold launch for subscribers on a weak network. When the saved subscription is still within its expiry, the SDK is now ready before it reads purchases from StoreKit.
