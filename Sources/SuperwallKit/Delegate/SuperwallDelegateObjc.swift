...
public protocol SuperwallDelegateObjc: AnyObject {
  ...
  /// Called when the ``EntitlementsInfo/status`` changes.
  ///
  /// You can use this function to update the state of your application.
  ///
  /// - Parameter newValue: The new value of the active ``EntitlementsInfo/status``.
  @MainActor
  @objc optional func entitlementStatusDidChange(to newValue: EntitlementStatusObjc)
