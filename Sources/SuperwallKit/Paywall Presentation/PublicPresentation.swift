...
public extension Superwall {
  ...
  @objc func getTrackInfo(
    ...
    return await objcGetTrackInfo(forEvent: event, params: params)
  }

  private func objcGetTrackInfo(
    forEvent event: String,
    params: [String: Any]? = nil
  ) async -> TrackInfoObjc {
    let result = await getTrackResult(forEvent: event, params: params)
...
public extension Superwall {
  ...
  @objc static func getTrackInfo(
    ...
    return await shared.objcGetTrackInfo(forEvent: event, params: params)
  }
}
