...
let englishStrings: [String: String] = [
  ...
  "customer_center_path_manage_subscription_web": "Manage subscription",
  "customer_center_web_manage_unavailable": "Manage your subscription using the link in your emailed receipt.",
  "customer_center_detail_nothing_to_manage": "There's nothing to manage for this purchase.",
  "customer_center_detail_managed_through": "Manage this subscription through %@.",
  "customer_center_detail_managed_where_bought": "Manage this subscription where you bought it.",
