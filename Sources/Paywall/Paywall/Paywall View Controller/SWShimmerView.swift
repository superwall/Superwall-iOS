...
final class SWShimmerView: UIView {
  ...
  var contentColor: UIColor = .black {
    didSet {
      imageView.tintColor = contentColor.withAlphaComponent(0.5)
  ...
  private var newPlaceholderView: UIImageView {
  ...
  private lazy var maskImageView = newPlaceholderView
  private lazy var imageView = newPlaceholderView
