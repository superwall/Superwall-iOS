...
internal class Cache {
    ...
    internal static let instance = Cache(name: "default")
    ...
    open var maxCachePeriodInSecond = Cache.defaultMaxCachePeriodInSecond
    ...
    internal init(name: String, path: String? = nil) {
        self.name = name
...
extension Cache {
    ...
    internal func write(data: Data, forKey key: String) {
    ...
    /// Read data for key
    internal func readData(forKey key:String) -> Data? {
    ...
    internal func readDataFromDisk(forKey key: String) -> Data? {
        return self.fileManager.contents(atPath: cachePath(forKey: key))
    }
    
    // MARK: - Read & write Codable types
    internal func write<T: Encodable>(codable: T, forKey key: String) throws {
        let data = try JSONEncoder().encode(codable)
        write(data: data, forKey: key)
    }
    
    internal func readCodable<T: Decodable>(forKey key: String) throws -> T? {
    ...
    internal func write(object: NSCoding, forKey key: String) {
        let data = NSKeyedArchiver.archivedData(withRootObject: object)
        write(data: data, forKey: key)
    }
    
    /// Write a string for key
    internal func write(string: String, forKey key: String) {
        write(object: string as NSCoding, forKey: key)
    }
    
    /// Write a dictionary for key
    internal func write(dictionary: Dictionary<AnyHashable, Any>, forKey key: String) {
        write(object: dictionary as NSCoding, forKey: key)
    }
    
    /// Write an array for key
    internal func write(array: Array<Any>, forKey key: String) {
    ...
    internal func readObject(forKey key: String) -> NSObject? {
    ...
    internal func readArray(forKey key: String) -> Array<Any>? {
        return readObject(forKey: key) as? Array<Any>
    }
    
    /// Read a dictionary for key
    internal func readDictionary(forKey key: String) -> Dictionary<AnyHashable, Any>? {
    ...
    internal func write(image: UIImage, forKey key: String, format: ImageFormat? = nil) {
        var data: Data? = nil
    ...
    internal func readImage(forKey key: String) -> UIImage? {
        let data = readData(forKey: key)
        if let data = data {
    ...
    internal func readImageForKey(key: String) -> UIImage? {
...
extension Cache {
    ...
    internal func cleanMemCache() {
        memCache.removeAllObjects()
    }
    
    internal func cleanDiskCache() {
        ioQueue.async {
            do {
    ...
    @objc internal func cleanExpiredDiskCache() {
