...
///
/// Pass an instance of this class to ``Superwall/Superwall/configure(apiKey:delegate:options:)`` to override the default paywall appearance and behavior.
public class SuperwallOptions: NSObject {
